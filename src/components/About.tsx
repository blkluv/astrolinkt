  ...
  return (
    <div className="flex flex-col items-start gap-6 lg:gap-8 px-3 lg:px-6 py-4">
      ...
      <div className="flex flex-col gap-4 text-lg">
        ...
        <p>
           Promote your verified Atlanta business on ATL5D 🍑TREE. We promote our Tribe across our social channels,
           and businesses only pay for verified leads or bookings.
        </p>
